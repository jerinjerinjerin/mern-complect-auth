...
const EmailVerificationPage = () => {
  ...
  const handleChange = (index, value) => {
    ...
    if (value.length > 1) {
      ...
      const lastFillIndex = newCode.findIndex((digit) => digit === "");
      const focusIndex = lastFillIndex >= 0 ? lastFillIndex : 5;
  ...
  const handleSubmit =async (e) => {
      e.preventDefault();
      const verifictionCode = code.join('');
  
      try {
        await verifyEmail(verifictionCode);
      ...
      >
        ...
        >
          ...
          <motion.button
            ...
            to-emerald-600 text-white font-bold py-3 px-4 rounded-lg 
